...
export default function GmScenarioDetail() {
  ...
  return <div className="report-detail gm-detail font-yomogi">
    ...
    <div className="report-detail-body">
      ...
      {scenario.officialUrl && <div className="report-detail-links gm-official-links"><a className="report-detail-link-btn official-btn" href={scenario.officialUrl} target="_blank" rel="noreferrer"><LinkIcon size={14} />公式ページ</a></div>}
    </div>
